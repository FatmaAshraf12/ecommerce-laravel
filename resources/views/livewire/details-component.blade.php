                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="submit" class="button button-add-to-cart"
                                                    wire:click.prevent="add_to_cart({{ $product->id }},'{{ $product->name }}',{{ $product->regular_price }})"><i>Add
                                                        to
                                                        cart</button>
                                                ...
                                                <div class="product-cart-wrap small hover-up">
                                                    <div class="product-img-action-wrap">
                                                        <div class="product-img product-img-zoom">
                                                            <a href="{{ route('product.details', ['slug' => $r->slug]) }}"
                                                                tabindex="0">
                                                                <img class="default-img"
                                                                    src="{{ asset('assets/imgs/shop/') }}/{{ $r->image }}-1.jpg"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('assets/imgs/shop/') }}/{{ $r->image }}-2.jpg"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="product-price">
                                                            @if ($r->sale_price)
                                                                ...
                                                                <span class="old-price">{{ $r->regular_price }}</span>
                                                            @else
                                                                <span>{{ $r->regular_price }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($new as $n)
                                <div class="single-post clearfix">
                                    <div class="image"><a
                                            href="{{ route('product.details', ['slug' => $n->slug]) }}">
                                            <img src="{{ asset('assets/imgs/shop/') }}/{{ $n->image }}-1.jpg"
                                                alt="product image"></a>
                                        <!--<img src="assets/imgs/shop/thumbnail-3.jpg" alt="#">-->
                                    </div>
                                    <div class="content pt-10">
                                        <h5><a
                                                href="{{ route('product.details', ['slug' => $n->slug]) }}">{{ $n->name }}</a>
                                        </h5>
