                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two"
                                type="button" role="tab" aria-controls="tab-two" aria-selected="false">New
                                added</button>
                        </li>
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('product.details', ['slug' => $item->slug]) }}">
                                                    <img class="default-img" height="250"
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a
                                                    href="{{ route('category.index', ['slug' => $item->category->slug]) }}">{{ $item->category->name }}</a>
                                            </div>
                                            <h2><a
                                            ...
                                            <div class="product-action-1 show">
                                                @if ($wishlist_items->contains($item->id))
                                                ...
                                                @else
                                                    <a aria-label="Add To Wishlist" class="action-btn hover-up"
                                                        href="#"
                                                        wire:click.prevent="add_to_wishlist({{ $item->id }},'{{ $item->name }}',{{ $item->regular_price }})"><i
                                                            class="fi-rs-heart"></i></a>
                                                @endif
                                                <a aria-label="Add To Cart" class="action-btn hover-up"
                                                    href="#"
                                                    wire:click.prevent="add_to_cart({{ $item->id }},'{{ $item->name }}',{{ $item->regular_price }})"><i
                        ...
                        @foreach ($categories as $category)
                            <div class="card-1">
                                <figure class=" img-hover-scale overflow-hidden">
                                    <a href="{{ route('category.index', ['slug' => $category->slug]) }}"><img
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('product.details', ['slug' => $item->slug]) }}">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop') }}/{{ $item->image }}"
                                                height="150" src="assets/imgs/shop/product-2-1.jpg"
                                                alt="{{ $item->name }}">
                                            <img class="hover-img"
                                                src="{{ asset('assets/imgs/shop') }}/{{ $item->image }}"
                                                height="150" alt="{{ $item->name }}">
                                        </a>
                                    </div>
